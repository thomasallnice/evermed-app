...
export class GoogleVisionClient {
   ...
   * @returns GoogleVisionResult with labels and safety status
   * @throws GoogleVisionError on API failures
   */
  async analyzeFoodImage(imageUrl: string): Promise<GoogleVisionResult> {
   ...
   */
  private parseResponse(response: VisionResponse): GoogleVisionResult {
